...
我自己也是经常漏接微信信息，为了尽量避免这种情况的出现，本着人生苦短我用python的原则，使用itchat库撸了代码实现自动回复好友私聊和群聊中@我的信息，同时将相关的私聊，@我的信息转存到微信的文件助手中。
### 使用方法

要使用代码 首先要安装python3，并使用`pip3 install itchat` 安装itchat库。

运行代码后，程序会自动下载一个二维码图片，使用微信扫一扫扫取二维码图片，实现登录后，保持程序运行，即可实现上述功能。
